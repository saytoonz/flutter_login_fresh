...
class _MyAppState extends State<MyApp> {
      ...
      LoginFreshTypeLoginModel(
          callFunction: (BuildContext _buildContext) {
            Navigator.of(_buildContext).push(
              MaterialPageRoute(
                builder: (_buildContext) => widgetLoginFreshPhone(),
              ),
            );
          },
          logo: TypeLogo.phone),
  ...
  Widget widgetLoginFreshPhone() {
    return LoginFreshPhoneNumber(
      callLogin: (BuildContext _context,
          Function isRequest,
          Function isVerify,
          Function errorWrongCode,
          Function setResend,
          String user,
          String password,
          bool isVerifyCode) {
